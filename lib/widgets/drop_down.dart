...
import 'package:chatz_gpt_mobile/providers/models_provider.dart';
...
class _ModelsDropDownWidgetState extends State<ModelsDropDownWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ModelsModel>>(future: modelsProvider.getAllModels(),builder: (context, snapshot){
